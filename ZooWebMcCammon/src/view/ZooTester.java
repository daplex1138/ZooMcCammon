...
public class ZooTester {
	...
	public static void main(String[] args) {
		...
		Zoo toAdd = new Zoo(zooKeeper, zooName, LocalTime.of(7, 00),  LocalTime.of(10, 00));
		...
		//Reptile snake = new Reptile("Harry", 1.0, 2.0, 3.0, "herbivore", true, true, "male", false, true, "scales", toAdd);
		//Reptile snake  = new Reptile(name, weight, length, height, diet_id, nocturnal, lay_eggs, gender_id, hasLegs, isVenomous, skinType, zoo_id)
